...
Route::get('yeu-thich', ['as'  => 'getwishlist', 'uses' =>'PagesController@view_wishlist']);
Route::post('home', 'PagesController@addwishlist')->name('addwishlist');
Route::get('yeu-thich/delete/{id}', ['as'  => 'getdeletewish', 'uses' =>'PagesController@getdeletewish']);
      ...
      Route::group(['prefix' => 'admin'], function() {
       ...
       // -------------------- quan ly danh muc-----------------------------
        ...
        Route::group(['prefix' => '/thuvien'], function() {;
          Route::get('',['as'       =>'getimage','uses' => 'ImageController@getlist']);
          Route::get('add',['as'        =>'getaddthuvien','uses' => 'ImageController@getadd']);
          Route::post('add',['as'       =>'posaddthuvien','uses' => 'ImageController@postadd']);
          //  Route::post('uploadMultiImage',['as'       =>'posaddthuvien','uses' => 'ImageController@uploadMultiImage']);
