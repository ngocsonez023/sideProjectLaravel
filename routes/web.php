...
Route::group(['middleware' => ['frontlogin']],function(){
	...
	Route::get('/getpaymentmethods', 'ProductsController@getpaymentmethods');

	Route::get('/checkout/momo/callback', 'ProductsController@momoCallback');
	Route::get('/checkout/callback/nganluong', 'ProductsController@nganluongCallback');
	Route::get('/paymentComponent', 'ProductsController@paymentComponent');
	//Place Order
