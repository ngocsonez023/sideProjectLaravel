				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Quà tặng khuyễn mã 1 : <input type="text" name="txtpromo1" id="inputtxtpromo1" value="{{ old('txtpromo1') }}" class="form-control" >
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Quà tặng khuyễn mã 1 : <input type="text" name="txtpromo2" id="inputtxtpromo2" value="{{ old('txtpromo2') }}" class="form-control" >
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Quà tặng khuyễn mã 1 : <input type="text" name="txtpromo3" id="inputtxtpromo3" value="{{ old('txtpromo3') }}" class="form-control" >
					      			</div>
					      		</div>				      			
				      		</div>
				      		<div class="form-group">				      			
				      			<div class="row">
					      			...
					      			<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">	
 										  <input type="checkbox" id="myCheck" name="sale_status" value="ON"  onclick="myFunction()">Bật
					      				Giá khuyến mãi :
						      			<div id="text" style="display:none">
						      				 <input type="text" name="price_sale"   value="" class="form-control">
											  <div class="form-group">
				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">					      			
					      			...
					      			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					      				...
					      				<textarea name="content" id="inputtxtReview" class="form-control" rows="4" value="" required="required"></textarea>
					      				<script type="text/javascript">
