            ...
            <div class="panel-body">
              ...
              <!-- hot new content -->
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                 ...
                 @if(isset($data->price_sale) && $data->sale_status == 'ON' && $data->start_date < $timenow && $data->end_date > $timenow)   
                          <label class="btn btn-large btn-block btn-warning">{!!number_format($data->price_sale)!!} vnd <span style="text-decoration: line-through;">
