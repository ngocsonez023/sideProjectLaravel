 <!-- main menu  navbar -->
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" role="navigation" id="main-Nav" style="background-color: #16a085;margin-bottom: 5px;font-size: 13px;">
      <div class="container">  
        <div class="row">
          ...
          <div class="collapse navbar-collapse" id="main-mav-top">
            <ul class="nav navbar-nav">
             ...
             <ul class="nav navbar-nav pull-right">
              ...
              <li class="dropdown" id="divid">
                <a  class="dropdown-toggle" data-toggle="dropdown"> <span class="glyphicon glyphicon-shopping-cart"><span class="badge" id="clicks">{!!Cart::count();!!}</span></span> Giỏ Hàng </a>
               <!--  <div id="root"></div> -->
              ...
              <!-- Authentication Links -->
                ...
                @else
                 ...
                 <?php 
                   ...
                   ->select(DB::raw('count(pro_id) as pro_id'),
                    'user_id')
                   ->groupBy('user_id')
                   ->get();
                   $wishdata = DB::table('wishlist')->first();
                 ?>
                   <a href="{!!url('yeu-thich')!!}" >Sản phẩm yêu thích 
                   @foreach($wish as $row)
                     @if (!empty($row->user_id) && $row->user_id == Auth::user()->id)
